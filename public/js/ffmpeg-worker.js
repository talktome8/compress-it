/**
 * FFmpeg Worker — Self-hosted, bundled version
 * Inlines const.js and errors.js to avoid cross-origin ES module import issues.
 * Based on @ffmpeg/ffmpeg@0.12.10
 */
...
const load = async ({
  ...
  try {
    ...
    self.createFFmpegCore = (
      await import(/* webpackIgnore: true */ /* @vite-ignore */ _coreURL)
    ).default;
